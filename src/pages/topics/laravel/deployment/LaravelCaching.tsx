  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="topic-card p-6 mb-6">
        ...
        <pre className="bg-secondary/50 p-4 rounded-lg overflow-x-auto"><code>{`use Illuminate\\Support\\Facades\\Cache;
...
$users = Cache::remember('users', 3600, function () {
    return User::all();
      ...
      <div className="topic-card p-6 mb-6">
        ...
        <pre className="bg-secondary/50 p-4 rounded-lg overflow-x-auto"><code>{`// Forget cache
Cache::forget('key');
