  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="topic-card p-6 mb-6">
        ...
        <pre className="bg-secondary/50 p-4 rounded-lg overflow-x-auto"><code>{`php artisan make:resource UserResource
...
class UserResource extends JsonResource
{
    public function toArray($request)
    {
      ...
      <div className="topic-card p-6 mb-6">
        ...
        <pre className="bg-secondary/50 p-4 rounded-lg overflow-x-auto"><code>{`// Single resource
return new UserResource($user);

// Collection
return UserResource::collection($users);`}</code></pre>
      </div>
