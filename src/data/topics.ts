...
export const topicsData: TopicCategory[] = [
  {
    ...
    topics: [
      ...
      { id: 'tables', title: 'HTML Tables', route: '/html/tables', category: 'html' },
      { id: 'data-attributes', title: 'Data Attributes', route: '/html/data-attributes', category: 'html' },
      { id: 'iframes', title: 'Iframes & Embedding', route: '/html/iframes', category: 'html' },
      { id: 'entities', title: 'HTML Entities', route: '/html/entities', category: 'html' },
      { id: 'performance', title: 'HTML Performance', route: '/html/performance', category: 'html' },
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'variables', title: 'CSS Variables', route: '/css/variables', category: 'css' },
      { id: 'transforms', title: 'Transforms', route: '/css/transforms', category: 'css' },
      { id: 'pseudo-classes', title: 'Pseudo-classes', route: '/css/pseudo-classes', category: 'css' },
      { id: 'units', title: 'CSS Units', route: '/css/units', category: 'css' },
  ...
  },
  {
  ...
  },
   {
    ...
    topics: [
      ...
      { id: 'controlled-uncontrolled', title: 'Controlled vs Uncontrolled', route: '/react/controlled-uncontrolled', category: 'react' },
      { id: 'lists-keys', title: 'Lists & Keys', route: '/react/lists-keys', category: 'react' },
      ...
      { id: 'useReducer', title: 'useReducer Hook', route: '/react/hooks/useReducer', category: 'react' },
      ...
      { id: 'reconciliation', title: 'Reconciliation & Virtual DOM', route: '/react/reconciliation', category: 'react' },
      { id: 'react-memo', title: 'React.memo', route: '/react/react-memo', category: 'react' },
      { id: 'performance', title: 'Performance Optimization', route: '/react/performance', category: 'react' },
      { id: 'state-colocation', title: 'State Colocation', route: '/react/state-colocation', category: 'react' },
